(function() {
  ...
  const actions = {
    ...
    'aiPaperDashboard.refresh': () => callGlobal('renderAiPaperDashboardStatus'),
    'aiPaperDashboard.print': () => callGlobal('printAiPaperDashboardStatus'),
    ...
    'aiPaperSchedule.refresh': () => callGlobal('refreshAiPaperSchedules'),
    'aiPaperSchedule.create': () => callGlobal('createAiPaperSchedule'),
    'aiPaperSchedule.delete': (element) => callGlobal('deleteAiPaperSchedule', actionArgument(element)),
    'aiPaperSchedule.run': (element) => callGlobal('runAiPaperScheduleRequest', actionArgument(element)),
    ...
    'aiPaperHistory.refresh': () => callGlobal('refreshAiPaperDecisionHistory'),
    'aiPaperHistory.loadReplay': () => callGlobal('loadAiPaperHistoryReplayRecords'),
    'aiPaperHistory.loadOne': (element) => callGlobal('loadOneAiPaperHistoryDecision', actionArgument(element)),
    'aiPaperPerformance.example': () => callGlobal('loadAiPaperPerformanceExample'),
    'aiPaperPerformance.fromReplay': () => callGlobal('loadReplayResultIntoPerformance'),
    'aiPaperPerformance.fromHistory': () => callGlobal('loadHistoryIntoPerformance'),
    'aiPaperPerformance.run': () => callGlobal('runAiPaperPerformanceSummary'),
    'aiPaperReviewPacket.sync': () => callGlobal('syncReviewPacketInputs'),
    'aiPaperReviewPacket.example': () => callGlobal('loadReviewPacketExample'),
    'aiPaperReviewPacket.build': () => callGlobal('buildAiPaperReviewPacket'),
    'aiPaperReviewPacket.copy': () => callGlobal('copyAiPaperReviewPacket'),
    'aiPaperAuditExport.sync': () => callGlobal('syncAuditExportInputs'),
    'aiPaperAuditExport.example': () => callGlobal('loadAuditExportExample'),
