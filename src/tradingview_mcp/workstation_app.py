"""Local browser workstation for charting, research, backtests, and LM Studio analysis.
...
def create_app() -> FastAPI:
    app = FastAPI(title="Autonomx Trading Research Workstation", version="1.0.0")
